...
from friend_module import send_friend_request, accept_friend_request, reject_friend_request, list_friend_requests, list_friends, show_friend_availability, show_friend_list_with_availability
